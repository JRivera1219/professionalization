...
class OrientationChecklistRequest(models.Model):
    ...
    request_orientation = fields.Many2one('professionalization', string='Employee Orientation')
    ...
    def confirm_send_mail(self):
        ...
        try:
            template_id = ir_model_data.get_object_reference('hr_academic_formation', 'orientation_request_mailer')[1]
        except ValueError:
            template_id = False
        try:
